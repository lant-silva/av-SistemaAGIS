...
public class AlunoDao implements ICrud<Aluno>, IIud<Aluno>{
	...
	public String iud(String acao, Aluno a) throws SQLException, ClassNotFoundException {
		...
		cs.setString(5, a.getDataNasc());
		cs.setString(6, a.getEmailPessoal());
		cs.setString(7, a.getEmailCorporativo());
		cs.setString(8, a.getDataSegundoGrau());
		cs.setString(9, a.getInstituicaoSegundoGrau());
		cs.setDouble(10, a.getPontuacaoVestibular());
		cs.setInt(11, a.getPosicaoVestibular());
		cs.setString(12, a.getAnoIngresso());
		cs.setString(13, a.getSemestreIngresso());
		cs.setString(14, a.getSemestreGraduacao());
